...
export const MobileVersion: React.FC<MobileVersion> = ({ classes }) => {
        var today = new Date
        return (
                <Grid container direction="row" className={classes.cardActiveItem} spacing={2}>
                        ...
                        <Grid item className={classes.cardActive} xs={9}>
                                <Box className={classes.cardActiveInform}>
                                        <InformCard size="XS" startDate={today} endDate={today} style="maxi " text="A perfect flirty number for Balls and Black Tie." />
                                </Box>
