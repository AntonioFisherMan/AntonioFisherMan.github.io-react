...
import { withStyles, Container, Grid, Box, Hidden } from '@material-ui/core'
                            ...
                            <Grid item>
                                ...
                                {props.orders.map((order: any) => <Grid container key={order._id}>
                                    ...
                                    {order.items.map((item: any) => <> <Box className={classes.orders__item} key={item._id}>
                                        ...
                                        <Grid item sm={4} >
                                            <InformItem text={item.text} fashion={item.style} size={item.size} startDate={item.startDate} endDate={item.endDate} />
                                        </Grid>
                                        <Grid item sm={2} className={classes.center}>
