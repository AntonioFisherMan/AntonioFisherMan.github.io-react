                        ...
                        <Grid container justify="center">
                                <Box>
                                        <form onSubmit={props.handleSubmit} style={{ marginTop: "20px" }}>
                                                ...
                                                <Field type="text" component={MyInput} name="newPassword" required fullWidth type="password" />
                                                <label for="verifyPassword">Confirm Password</label>
                                                <Field type="text" component={MyInput} name="verifyPassword" required fullWidth type="password" />
